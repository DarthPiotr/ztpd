...
//        StandardAnalyzer analyzer = new StandardAnalyzer(); // Zadanie 5.A
//        EnglishAnalyzer analyzer = new EnglishAnalyzer(); // Zadanie 9
        PolishAnalyzer analyzer = new PolishAnalyzer(); // Zadanie 11
...
//            w.addDocument(buildDoc("Dummy and yummy title", "9780525656161"));
        ...
        String querystr = "*:*"; // Zadanie 6.A
//        querystr = "dummy"; // Zadanie 7.A / 9
//        querystr = "and"; // Zadanie 7.B / 9

        // Zadanie 12
//        querystr = "9780062316097";
//        querystr = "urodzić";
//        querystr = "rodzić";
//        querystr = "ro*";
//        querystr = "ponieważ";
